...
def construct_closing(test_suite_url=None):
    ...
    \n\nWe've generated test suites according to your scan results! Checkout the [Test Suite in our Giskard Space]({test_suite_url}) and [Giskard Documentation](https://docs.giskard.ai/en/latest/getting_started/quickstart/index.html) to learn more about how to test your model.
    """
    
    if test_suite_url is None:
        giskard_hub_wording = f"""
        \n\nCheckout out the [Giskard Space]({GISKARD_HUB_URL}) and [Giskard Documentation](https://docs.giskard.ai/en/latest/getting_started/quickstart/index.html) to learn more about how to test your model.
        """
